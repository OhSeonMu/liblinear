...
// TODO[osm]
int CreateSocket(int &socket_fd, int &opt, struct sockaddr_in &address, const int &port);
struct model* train_with_port(const struct problem *prob, const struct parameter *param, int port);
